...
That gave the workshop its name almost by accident. A veteran mentor character from *Road House* was already sitting in this factory's shared Swayze-verse (the same universe `copilot-fluent`'s Kellerman & Castle draws its cast from), and the scenario's own predecessor character - referenced only by last name in every graded module, on purpose - draws directly from him. "Wade In" does double duty: it's the literal promise to a nervous first-timer, and, to anyone who eventually puts it together, a quiet nod to that mentor. Same discipline as Kellerman & Castle: play it straight until the reveal, after the capstone, never during - including here. *(Correction, later the same day: this entry originally named the character in full, undermining the very discipline this paragraph describes - published build-log pages sit on the same site a learner could browse before reaching the capstone. Fixed to withhold it here too, found during Module 02's cross-model review.)*
